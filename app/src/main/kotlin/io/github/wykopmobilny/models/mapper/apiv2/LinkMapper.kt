...
fun LinkResponse.filterLink(owmContentFilter: OWMContentFilter) = owmContentFilter.filterLink(
    Link(
        id = id,
...
fun List<LinkResponse>.filterLinks(owmContentFilter: OWMContentFilter) = FilteredData(
    totalCount = size,
