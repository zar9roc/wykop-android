...
class LinkDetailsPresenter
    ...
    constructor(
        ...
        fun sendReply(
            body: String,
            typedInputStream: WykopImageFile,
            containsAdultContent: Boolean,
        ) {
            val replyCommentId = view!!.getReplyCommentId()
            if (replyCommentId != -1L) {
                linksApi
                    .commentAdd(body, containsAdultContent, typedInputStream, linkId, replyCommentId)
                    .subscribeOn(schedulers.backgroundThread())
                    .observeOn(schedulers.mainThread())
                    .subscribe(
                        {
                ...
                linksApi
                    .commentAdd(body, containsAdultContent, typedInputStream, linkId)
                    .subscribeOn(schedulers.backgroundThread())
                    .observeOn(schedulers.mainThread())
                    .subscribe(
                        {
        ...
        fun sendReply(
            ...
            if (replyCommentId != -1L) {
                linksApi
                    .commentAdd(body, embed, containsAdultContent, linkId, replyCommentId)
                    .subscribeOn(schedulers.backgroundThread())
                    .observeOn(schedulers.mainThread())
                    .subscribe(
                        {
                ...
                linksApi
                    .commentAdd(body, embed, containsAdultContent, linkId)
                    .subscribeOn(schedulers.backgroundThread())
                    .observeOn(schedulers.mainThread())
                    .subscribe(
                        {
