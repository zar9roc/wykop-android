...
data class RelatedResponseV3(
    ...
    // Realny adres i miniatura zyja w zagniezdzonych source/media -
    // plaskie "url" w praktyce nie przychodzi (bylo zawsze null).
    @field:Json(name = "url") val url: String?,
    @field:Json(name = "source") val source: RelatedSourceResponseV3?,
...
@JsonClass(generateAdapter = true)
data class RelatedSourceResponseV3(
