...
fun EntryResponse.filterEntry(owmContentFilter: OWMContentFilter) = owmContentFilter.filterEntry(
    Entry(
        id = id,
...
fun List<EntryResponse>.filterEntries(owmContentFilter: OWMContentFilter) = FilteredData(
    totalCount = size,
