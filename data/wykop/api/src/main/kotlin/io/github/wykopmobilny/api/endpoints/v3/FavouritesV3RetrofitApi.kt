...
interface FavouritesV3RetrofitApi {
    ...
    // POST/DELETE /v3/favourites to endpointy nieudokumentowane w spec; zwracaja
    // 204 bez body - stad Response<Unit> + requireSuccessful() zamiast
    // WykopApiResponseV3 (pusty body nie parsuje sie z Moshi).
    @POST("v3/favourites")
