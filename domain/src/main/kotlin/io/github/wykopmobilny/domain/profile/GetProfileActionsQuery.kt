...
internal class GetProfileActionsQuery
    @Inject
    constructor(
        ...
        private fun LinkInfo.toUi(linksPreference: LinksPreference) =
            ListElementUi.Link(
                ...
                voteAction = safeCallback { },
                thumbnail =
                    if (linksPreference.showLinkThumbnail || linksPreference.useSimpleList) {
...
internal fun UserInfo.toUi(onClicked: (() -> Unit)?) =
    UserInfoUi(
        avatar =
            AvatarUi(
                avatarUrl = avatarUrl,
