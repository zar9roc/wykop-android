...
internal class GetProfileDetailsQuery
    @Inject
    constructor(
            ...
            combine(
                ...
                val header =
                    ProfileHeaderUi(
                        ...
                        banReason =
                            if (profile?.banReason != null || profile?.banDate != null) {
                                BanReasonUi(
                ...
                val contextMenuOptions =
                    if (loggedUser == null || loggedUser.id == profileId) {
                        listOf(badgesOption())
                    } else {
                        buildList {
        ...
        private fun badgesOption() =
            ContextMenuOptionUi(
                label = Strings.Profile.BADGES,
                onClick = safeCallback { TODO() },
            )

        private fun privateMessageOption() =
            ContextMenuOptionUi(
