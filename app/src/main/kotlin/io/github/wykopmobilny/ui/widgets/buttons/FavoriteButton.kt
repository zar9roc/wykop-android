...
class FavoriteButton
    ...
    constructor(
        ...
        init {
            ...
            favoriteDrawable =
                context
                    .obtainStyledAttributes(arrayOf(R.attr.favoriteDrawable).toIntArray())
                    .use { it.getDrawable(0)!! }

            favoriteOutlineDrawable =
                context
                    .obtainStyledAttributes(arrayOf(R.attr.favoriteOutlineDrawable).toIntArray())
                    .use { it.getDrawable(0)!! }
        }
    }
