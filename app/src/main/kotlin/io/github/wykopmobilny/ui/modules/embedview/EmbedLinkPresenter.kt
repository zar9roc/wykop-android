...
class EmbedLinkPresenter
    ...
    constructor(
        ...
        fun playUrl(url: String) {
            linkDomain =
                if (!url.contains(GFYCAT_MATCHER)) {
                    url.getDomainName()
                } else {
                    GFYCAT_MATCHER
                }
            when (linkDomain) {
                ...
                STREAMABLE_MATCHER -> {
                    Maybe
                        .fromCallable { Uri.parse(url).lastPathSegment }
                ...
                MOBILE_YOUTUBE_MATCHER, SIMPLE_YOUTUBE_MATCHER, YOUTUBE_MATCHER -> {
                    view?.exitAndOpenYoutubeActivity()
                }
            }
        }
