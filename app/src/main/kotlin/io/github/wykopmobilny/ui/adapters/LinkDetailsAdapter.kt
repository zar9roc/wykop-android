...
class LinkDetailsAdapter
    ...
    constructor(
        ...
        override fun onCreateViewHolder(
            ...
            when (viewType) {
                LinkHeaderViewHolder.TYPE_HEADER -> {
                    LinkHeaderViewHolder.inflateView(
                        parent,
                        userManagerApi,
                        navigator,
                        linkHandler,
                ...
                LinkCommentViewHolder.TYPE_EMBED, LinkCommentViewHolder.TYPE_NORMAL -> {
                    LinkCommentViewHolder.inflateView(
                        parent,
                        viewType,
                        userManagerApi,
                        navigator,
