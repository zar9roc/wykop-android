...
internal class EntriesAdapter :
    PagingDataAdapter<ListElementUi, EntriesAdapter.EntryViewHolder>(
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int,
    ): EntryViewHolder = EntryViewHolder(ItemLinkBinding.inflate(LayoutInflater.from(parent.context), parent, false))
...
internal object EntriesComparator : DiffUtil.ItemCallback<ListElementUi>() {
    override fun areItemsTheSame(
        oldItem: ListElementUi,
        newItem: ListElementUi,
