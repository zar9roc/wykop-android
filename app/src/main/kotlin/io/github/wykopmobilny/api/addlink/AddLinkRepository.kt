...
class AddLinkRepository @Inject constructor(
    ...
    override fun getDraft(url: String) = rxSingle { addlinkApi.getDraft(url) }
        .retryWhen(userTokenRefresher)
        .flatMap(ErrorHandler<NewLinkResponse>())

    override fun getImages(key: String) = rxSingle { addlinkApi.getImages(key) }
        .retryWhen(userTokenRefresher)
