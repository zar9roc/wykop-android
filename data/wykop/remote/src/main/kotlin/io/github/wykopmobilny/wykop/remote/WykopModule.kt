...
internal class WykopModule {
    ...
    @Reusable
    @Provides
    fun reportsV3RetrofitApi(retrofit: Retrofit) = retrofit.create<io.github.wykopmobilny.api.endpoints.v3.ReportsV3RetrofitApi>()
    ...
    @Reusable
    @Provides
    fun favouritesV3RetrofitApi(retrofit: Retrofit) = retrofit.create<FavouritesV3RetrofitApi>()

    @Reusable
    @Provides
    fun suggestV3RetrofitApi(retrofit: Retrofit) = retrofit.create<SuggestV3RetrofitApi>()

    @Provides
    @Reusable
    fun searchV3RetrofitApi(retrofit: Retrofit) = retrofit.create<SearchV3RetrofitApi>()

    @Reusable
    @Provides
    fun pmV3RetrofitApi(retrofit: Retrofit) = retrofit.create<PmV3RetrofitApi>()
}
