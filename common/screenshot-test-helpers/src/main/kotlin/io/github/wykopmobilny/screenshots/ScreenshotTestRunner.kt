...
class ScreenshotTestRunner : AndroidJUnitRunner() {
    ...
    override fun newApplication(
        ...
        className: String,
        context: Context,
    ): Application = super.newApplication(cl, ScreenshotTestsApplication::class.java.name, context)
}

class ScreenshotTestsApplication :
    Application(),
    ApplicationInjector {
