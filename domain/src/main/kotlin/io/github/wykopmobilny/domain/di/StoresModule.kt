...
internal class StoresModule {
    ...
    @Singleton
    @Provides
    fun blacklistStore(retrofitApi: ScraperRetrofitApi, storage: AppStorage, appScopes: AppScopes) =
    ...
    @Singleton
    @Provides
    fun loginStore(retrofitApi: LoginRetrofitApi, storage: UserInfoStorage, appScopes: AppScopes, errorBodyParser: ErrorBodyParser) =
        StoreBuilder.from(
