...
class DownvoterListAdapter
    @Inject
    constructor() : androidx.recyclerview.widget.RecyclerView.Adapter<DownvoterViewHolder>() {
        val items = ArrayList<Downvoter>()

        override fun onBindViewHolder(
            holder: DownvoterViewHolder,
            position: Int,
        ) {
        ...
        override fun onCreateViewHolder(
            parent: ViewGroup,
            viewType: Int,
        ): DownvoterViewHolder = DownvoterViewHolder(DownvotersListItemBinding.inflate(parent.layoutInflater, parent, false))
    }
